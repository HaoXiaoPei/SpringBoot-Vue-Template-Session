<template>
  <div style="text-align: center;margin: 0 20px">
    ...
    <div style="margin-top: 50px">
      <el-input :prefix-icon="User" v-model="form.username" type="text" placeholder="用户名/邮箱">
        <!--            <template #prefix>-->
        <!--              <el-icon><User /></el-icon>-->
        <!--            </template>-->
      </el-input>
      <el-input :prefix-icon="Lock" v-model="form.password" type="password" style="margin-top: 10px" placeholder="密码">
        <!--            <template #prefix>-->
